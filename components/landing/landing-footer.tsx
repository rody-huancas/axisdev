...
const LandingFooterInner = () => {
  ...
  return (
    <footer className="flex shrink-0 items-center justify-between border-t border-[#DDDBD3] px-14 py-3" style={{ background: "#EEEDE7" }}>
      ...
      <a href="https://github.com/rody-huancas/axisdev" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-[10.5px] text-[#777] no-underline hover:text-[#111] transition-colors" style={{ fontFamily: "var(--font-geist-mono)" }}>
